...
- `legacyAndInfluence`: Explains how cultural/ideological context may affect perception and score.
...
- **Output:** `{ summary, details, legacyAndInfluence, fullReport }` (see types above)
