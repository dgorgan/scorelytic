...
import { displayCell, prettyTooltip } from '@/components/dashboard/utils';
      ...
      <table className="w-full min-w-max border border-gray-300 rounded-lg shadow text-sm bg-white">
        <thead className="bg-neutral-100 sticky top-0 z-10">
          <tr>
            ...
            <th className="px-4 py-2 border-b font-bold text-gray-900 w-[200px] max-w-[300px]">
              Seed
            </th>
            <th className="px-4 py-2 border-b font-bold text-gray-900 w-[200px] max-w-[300px]">
              LLM
            </th>
            <th className="px-4 py-2 border-b font-bold text-gray-900 w-[100px] max-w-[300px]">
              Similarity
            </th>
