...
describe('DashboardControls', () => {
  ...
  it('handles view toggle buttons', () => {
    ...
    const advancedQAButton = screen.getByRole('button', { name: /Advanced QA/ });
    fireEvent.click(advancedQAButton);
    
    expect(mockProps.setGroupedView).toHaveBeenCalledWith(false);
    
    const groupedViewButton = screen.getByRole('button', { name: /Grouped View/ });
  ...
  it('shows correct active states for filter buttons', () => {
    const propsWithUnreviewedFilter = { ...mockProps, filter: 'unreviewed' as const };
